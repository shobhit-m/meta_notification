            ...
            class UserNotificationsController < ApplicationController
                ...
                def notifications
                  if MnAuthorizers::UserNotificationAuthorizer.readable_by?(current_user)
                    ...
                    @notifications =  MetaNotification::UserNotification.select(:id,:user_id, mobile_or_in_app, :is_read, "mn_notification_types.name", "mn_notification_types.icon", "mn_notification_types.label")
